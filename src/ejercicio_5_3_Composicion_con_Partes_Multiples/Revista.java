 ...
 * @author Angel Mora
 * 
 *         Modificar el programa anterior para que soporte que la biblioteca
 *         también pueda contener una colección de revistas. Las revistas
 *         contienen los siguientes atributos: nombre de la revista, año de
 *         publicación, periodicidad, editorial y país. Las clases Libro y
 *         Revista deben ser subclases de una clase denominada Publicación, la
 *         cual debe contener atributos compartidos entre las dos clases.
 *         Agregar métodos a la clase biblioteca para que se puedan agregar y
 *         listar revistas.
 */
